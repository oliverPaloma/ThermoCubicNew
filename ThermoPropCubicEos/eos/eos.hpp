...
struct CubicEOSProps{
    ...
    std::vector<double> ln_phi_T_perturbada;
    std::vector<double> ln_phi_P_perturbada;

    std::vector<double> dA_ln_phi_T;  // Derivações em 05/05/25 //std::vector<double> ln_phiV;
    std::vector<double> dA_ln_phi_P;

    std::vector<double> dN_ln_phi_T;  // Derivações em 05/05/25 //std::vector<double> ln_phiV;
    std::vector<double> dN_ln_phi_P;
